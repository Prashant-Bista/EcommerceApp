...
class SplashController{
  ...
  SplashController({required this.tickerProvider}){
    ...
    splashAnimationController = AnimationController(vsync: tickerProvider,duration: Duration(seconds: 2,),)..forward().then((value)=>routeController.routeToMainScreen(shouldRemovePrevious: true));
