...
late UserListController userListController;
  ...
  Widget build(BuildContext context,ref) {
    ...
    return userListData.userList!.isEmpty
        ? Skeletonizer(
        ...
        : GridView.builder(itemCount:userListData.userList!.length,gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2,mainAxisSpacing: 2,childAspectRatio: 1,crossAxisSpacing: 2), itemBuilder: (context,index)=> GestureDetector(
        onTap: () {
      routeController.routeToUserProfile(extra: {"user":userListData.userList![index]});
    },
    child: Expanded(child: UsersCard(user: userListData.userList![index])))
    );
  }
}
